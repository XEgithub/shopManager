<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dingding.aspx.cs" Inherits="Recruit_dingding" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
        dd.config({
            url: 'http://www.datahunt.cn/dingding/dingding.aspx',
            agentId: '<%=agentId%>',
            corpId: '<%=CorpID%>',
            timeStamp: '<%=timestamp%>',
            nonceStr: '<%=nonceStr%>',
        ...
        dd.ready(function () {
            ...
            dd.runtime.permission.requestAuthCode({
                ...
                onSuccess: function (result) {
                    ...
                    location.href = "http://www.datahunt.cn/dingding/dd_dailyreport.aspx?usercode=" + result.code + "&access_token=" + access_token;
                },
