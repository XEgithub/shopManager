    ...
    public void getalldepartment(string access_token)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < record.Count;i++)
            {
                ...
                deparmentlists.Add(jp["id"].ToString());
                deparmentnamexxx.Add(jp["name"].ToString());
                parentid.Add(jp["parentid"].ToString());
    ...
    public void getalldepartmentlist(string access_token, string departmentid, string parentid, string departmentname)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < record.Count;i++)
            {
                ...
                userid = jp["userid"].ToString();
                username = jp["name"].ToString();
                position = jp["position"].ToString();
